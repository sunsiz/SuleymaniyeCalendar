...
{
    private Mock<DataService> _mockDataService = null!;
    private Mock<IRtlService> _mockRtlService = null!;
    private Mock<ILocalizationResourceManager> _mockLocalizationManager = null!;

    [TestInitialize]
    public void Setup()
    {
#if !ANDROID
        Assert.Inconclusive("Widget tests require Android runtime; skipped on non-Android test runners.");
#endif
