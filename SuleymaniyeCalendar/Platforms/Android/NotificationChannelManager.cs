...
namespace SuleymaniyeCalendar
{
	...
	private static NotificationManager _notificationManager;
		...
		private static string _alarmAlarmChannelId = "SuleymaniyeTakvimialarmalarmchannelId";
		private static string _alarm1AlarmChannelId = "SuleymaniyeTakvimialarmalarm1channelId";
		...
		private static string _alarm1ChannelName = "Suleymaniye Takvimi Alarm Alarm 1";
		...
		private static string _alarm1ChannelDescription = "The Suleymaniye Takvimi alarm alarm 1 channel.";
        ...
        internal static void CreateAlarmNotificationChannels()
        {
            ...
            Android.Net.Uri UriOf(int res) =>
                Android.Net.Uri.Parse($"{Android.Content.ContentResolver.SchemeAndroidResource}://{pkg}/{res}");

            var birdsSound = UriOf(ResourceConstant.Raw.kus);
            var roosterSound = UriOf(ResourceConstant.Raw.horoz);
            var adhanSound = UriOf(ResourceConstant.Raw.ezan);
            var alarmSound = UriOf(ResourceConstant.Raw.alarm);
            var alarm1Sound = UriOf(ResourceConstant.Raw.alarm2);
            ...
            if (Build.VERSION.SdkInt >= BuildVersionCodes.O)
            {
                ...
                var roosterAlarmChannel = new NotificationChannel(_alarmRoosterChannelId, roosterAlarmChannelNameJava,
                    NotificationImportance.Max)
                {
                    Description = _roosterChannelDescription
                };
                var adhanAlarmChannel = new NotificationChannel(_alarmAdhanChannelId, adhanAlarmChannelNameJava,
                    NotificationImportance.Max)
                {
                    Description = _adhanChannelDescription
                };
                var alarmAlarmChannel = new NotificationChannel(_alarmAlarmChannelId, alarmAlarmChannelNameJava,
                    NotificationImportance.Max)
                {
                    Description = _alarmChannelDescription
                };
                var alarm1AlarmChannel = new NotificationChannel(_alarm1AlarmChannelId, alarm1AlarmChannelNameJava,
                    NotificationImportance.Max)
                {
                    Description = _alarm1ChannelDescription
                };
                var alarm2AlarmChannel = new NotificationChannel(_alarm2AlarmChannelId, alarm2AlarmChannelNameJava,
                    NotificationImportance.Max)
                {
                    Description = _alarm2ChannelDescription
                };
                var alarm3AlarmChannel = new NotificationChannel(_alarm3AlarmChannelId, alarm3AlarmChannelNameJava,
                    NotificationImportance.Max)
                {
                    Description = _alarm3ChannelDescription
                };
                var alarm4AlarmChannel = new NotificationChannel(_alarm4AlarmChannelId, alarm4AlarmChannelNameJava,
                    NotificationImportance.Max)
                {
  ...
  //      public override void OnReceive(Context context, Intent intent)
		...
		//			.SetLargeIcon(BitmapFactory.DecodeResource(Android.App.Application.Context.Resources, Resource.Drawable.app_logo))
		//			.SetDefaults(0)
		...
		//	var notificationIntent = new Intent(Android.App.Application.Context, typeof(MainActivity));
